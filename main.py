...
class Trainer:
    ...
    def train(self):
        ...
        model_name = f"{self.args.interval} + {self.args.seed} + {self.test_metrics['accuracy']} + {self.test_metrics['precision']} + {self.test_metrics['f1']}.pt "  
