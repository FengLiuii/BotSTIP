...
from models.HyperGraph import HyperGraphStructuralLayer_AFC, HyperGraphStructuralLayer_Louvain, HyperGraphStructuralLayer_Knn_and_Kmeans,HyperGraphStructuralLayer_Knn, HyperGraphStructuralLayer_Louvain_and_knn
...
class BotDyGNN(nn.Module):
    ...
    def build_model(self):
        ...
        position_encoding_bidirectional_links_ratio_layer = PositionEncodingBidirectionalLinks(
            hidden_dim=self.hidden_dim)
        structural_layer = HyperGraphStructuralLayer_AFC(hidden_dim=self.hidden_dim,
