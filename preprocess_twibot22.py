...
def save_global_index():
    user_df = pd.read_json(r"D:\\WSL\\Work\\TwiBot-22\\TwiBot-22\\user.json")
    user_idx = user_df['id']   
...
def split_user_by_interval():
    ...
    user_nums = []
    if not os.path.exists("./processed_data/graph_data/global_index"):
        os.makedirs("./processed_data/graph_data/global_index")
    for date in date_list:
        ...
        path = "./processed_data/graph_data/global_index/global_index_in_snapshot_{}.pt".format(str(date))
...
def generate_edge_for_all_snapshot():
    ...
    if not os.path.exists("./processed_data/graph_data/edge_index"):
        os.makedirs("./processed_data/graph_data/edge_index")
    if not os.path.exists("./processed_data/graph_data/edge_type"):
        os.makedirs("./processed_data/graph_data/edge_type")

    global_index_dir_path = r"./processed_data/graph_data/global_index/"
    for root, dirs, files in os.walk(global_index_dir_path):
        for file in files:
            ...
            snapshot_edge_file_path = os.path.join("./processed_data/graph_data/edge_index", snapshot_edge_file_name)
            ...
            snapshot_edge_type_file_path = os.path.join("./processed_data/graph_data/edge_type", snapshot_edge_type_file_name)
...
def generate_position_information_for_all_snapshot():
    ...
    edge_index_dir_path = r"./processed_data/graph_data/edge_index"
    global_index_dir_path = r"./processed_data/graph_data/global_index/"
    clustering_coefficient_dir_path = r"./processed_data/graph_data/position_encoding/clustering_coefficient"
    if not os.path.exists(clustering_coefficient_dir_path):
        os.makedirs(clustering_coefficient_dir_path)
    betweenness_centrality_dir_path = r"./processed_data/graph_data/position_encoding/betweenness_centrality"
    if not os.path.exists(betweenness_centrality_dir_path):
        os.makedirs(betweenness_centrality_dir_path)
    bidirectional_links_ratio_dir_path = r"./processed_data/graph_data/position_encoding/bidirectional_links_ratio"
...
def generate_pyg_graph_for_all_snapshot():
    ...
    edge_dir_path = r"./processed_data/graph_data/edge_index"
    graph_dir_path = r"./processed_data/graph_data/graphs"
    global_index_dir_path = r"./processed_data/graph_data/global_index"
    clustering_coefficient_dir_path = r"./processed_data/graph_data/position_encoding/clustering_coefficient"
    bidirectional_links_ratio_dir_path = r"./processed_data/graph_data/position_encoding/bidirectional_links_ratio"
    edge_type_dir_path = r"./processed_data/graph_data/edge_type"
